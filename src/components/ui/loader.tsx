...
export const LoaderThree = () => {
  return (
    <motion.svg
      ...
      className="h-20 w-20 stroke-cyan-200 [--fill-final:var(--color-cyan-400)] [--fill-initial:var(--color-cyan-500)] dark:stroke-cyan-200 dark:[--fill-final:var(--color-yellow-500)] dark:[--fill-initial:var(--color-neutral-800)]"
    >
