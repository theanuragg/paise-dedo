...
export class TransactionIndexer {
  ...
  async indexPoolTransactions(
    ...
    console.log(
      `✅ Indexed ${filteredTransactions.length} transactions for pool ${poolAddress}`
    );
  ...
  async indexMeteoraTransactions(
    ...
    console.log(
      `✅ Indexed ${filteredTransactions.length} Meteora transactions`
    );
    return filteredTransactions;
  }
  ...
  async indexUserTransactions(
    ...
    console.log(
      `✅ Indexed ${filteredTransactions.length} transactions for user ${userWallet}`
    );
    return filteredTransactions;
  }
